                ...
                <div className="md:mx-52">
                    <div>
                        <Swiper
                            ...
                            modules={[Pagination]}
                            className=" sm:h-[440px] h-[300px]  w-[270px] md:w-[550px]"
                        >{dataExtra.map(({ id, name, description, imageUrl }) => (
                            <SwiperSlide key={id}>
                                <div className="flex px-6 row md:flex-col py-6 h-[300px]  sm:h-[400px] rounded-lg cursor-pointer bg-[rgba(11,98,90)] flex-col gap-x-6 sm:gap-x-0 group hover:bg-[rgba(11,98,90)] transition-all duration-300 border-secondary border-2">
